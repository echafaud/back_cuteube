    ...
    async def record_view(self, user: User, view: BaseView):
        try:
            ...
            if visitor_visits.visits:
                ...
                if time_now > visit_time > time_collision or visitor_visits.visits[0].confidence > 0.94:
                    if await self.count_viewer_video_views(user, view) < 6:
